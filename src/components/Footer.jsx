    ...
    return (
        <div className="w-full min-h-screen bg-white text-zinc-800 flex flex-col font-founder">
            <div className="flex flex-row p-0">
                <div className="w-1/2 flex flex-col pb-[6.8vw] pt-[5.5vw] px-[3.5vw]">
                    <div className="headings">
                        {
                            ["EYE-", "OPENING"].map((item, index) => (
                                <h2
                                    key={index}
                                    className={`uppercase font-founders leading-none text-[8vw] ${index === 0 ? "-mb-8" : ""}`}
                                >
                                    {item}
                                </h2>
                            ))
                ...
                <div className="w-1/2 flex flex-col gap-[3.7vw] pb-[6.8vw] pt-[6vw]">
                    <h2 className="-mb-6 uppercase leading-none text-[7.5vw] text-zinc-800 font-founders">
                        presentations
                    </h2>

                    <div className="flex flex-col gap-[2vw]">
                        <div className="flex flex-col gap-5">
                            <p className="text-[1vw] text-zinc-800 font-neue">S:</p>
                            <div className="flex flex-col gap-1">
                                {socialLinks.map((item, index) => (
                                    <a
                                        key={index}
                                        className="text-[1.1vw] text-zinc-700 tracking-tight font-neue hover:text-zinc-900 transition-colors"
                                        href="#"
                        ...
                        <div className="flex flex-row justify-between items-start mr-[6.2vw]">
                            <div className="flex flex-col gap-4">
                                <p className="text-[1vw] text-zinc-800 font-neue">L:</p>
                                <div className="flex flex-col">
                                    <a
                                        className="text-[1.1vw] text-zinc-700 relative group font-neue hover:text-zinc-900 transition-colors"
                                        href="#"
                            ...
                            <div className="flex flex-col gap-[1vw]">
                                <p className="text-[1vw] text-zinc-800 font-neue">M:</p>
                                <div className="flex flex-col gap-1">
                                    {menuLinks.map((item, index) => (
                                        <a
                                            key={index}
                                            href="#"
                                            className="text-[1.1vw] tracking-tight text-zinc-700 relative group font-neue hover:text-zinc-900 transition-colors"
                        ...
                        <div className="flex flex-col gap-[3vw] mt-0">
                            <div className="flex flex-col gap-4">
                                <p className="text-[1vw] text-zinc-800 font-neue">E:</p>
                                <div className="flex flex-col">
                                    <a
                                        className="text-[1.1vw] text-zinc-700 font-neue hover:text-zinc-900 transition-colors"
                            ...
                            <div className="flex flex-row justify-between items-center gap-4 mr-[4.5vw]">
                                <h2 className="text-base text-zinc-500 font-neue">
                                    © ochi design 2025.
                                ...
                                <h2 className="text-base text-zinc-500 font-neue hover:text-zinc-700 transition-colors"> Website by Obys</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full flex justify-start px-10 mt-1 mb-12">
                <svg
                    width="72"
                    height="30"
                    viewBox="0 0 72 30"
