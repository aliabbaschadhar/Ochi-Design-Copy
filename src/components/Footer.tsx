    ...
    return (
        <div className="w-full min-h-screen bg-white text-zinc-800 flex flex-col font-founder">
            <div className="flex flex-col md:flex-row p-0">
                <div className="w-full md:w-1/2 flex flex-col pb-8 md:pb-[4vw] lg:pb-[6.8vw] pt-10 md:pt-[3.5vw] lg:pt-[5.5vw] px-6 md:px-[2.5vw] lg:px-[3.5vw]">
                    <div className="headings">
                        {
                            ["EYE-", "OPENING"].map((item, index) => (
                                <h2
                                    key={index}
                                    className={`uppercase font-founders leading-none text-6xl sm:text-7xl md:text-[7vw] lg:text-[8vw] ${index === 0 ? "-mb-2 sm:-mb-4 md:-mb-4 lg:-mb-8" : ""}`}
                                >
                                    {item}
                                </h2>
                            ))
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-6 sm:gap-8 md:gap-[2.5vw] lg:gap-[3.7vw] pb-8 md:pb-[4vw] lg:pb-[6.8vw] pt-6 md:pt-[4vw] lg:pt-[6vw] px-6 md:px-4 lg:px-0">
                    <h2 className="-mb-2 sm:-mb-4 md:-mb-3 lg:-mb-6 uppercase leading-none text-5xl sm:text-6xl md:text-[7vw] lg:text-[7.5vw] text-zinc-800 font-founders">
                        presentations
                    </h2>

                    <div className="flex flex-col gap-8 md:gap-[1.5vw] lg:gap-[2vw]">
                        <div className="flex flex-col gap-3 md:gap-3 lg:gap-5">
                            <p className="text-sm md:text-[1.6vw] lg:text-[1.4vw] text-zinc-800 font-neue">S:</p>
                            <div className="flex flex-row md:flex-col flex-wrap gap-3 md:gap-1">
                                {socialLinks.map((item, index) => (
                                    <a
                                        key={index}
                                        className="text-base sm:text-lg md:text-[1.5vw] lg:text-[1.3vw] mr-4 md:mr-0 text-zinc-700 tracking-tight font-neue hover:text-zinc-900 transition-colors"
                                        href="#"
                        ...
                        <div className="flex flex-col md:flex-row lg:flex-row justify-between items-start gap-8 md:gap-4 lg:gap-0 md:mr-4 lg:mr-[6.2vw]">
                            <div className="flex flex-col gap-3 md:gap-3 lg:gap-4">
                                <p className="text-sm md:text-[1.6vw] lg:text-[1.4vw] text-zinc-800 font-neue">L:</p>
                                <div className="flex flex-col">
                                    <a
                                        className="text-base sm:text-lg md:text-[1.4vw] lg:text-[1.3vw] text-zinc-700 relative group font-neue hover:text-zinc-900 transition-colors"
                                        href="#"
                            ...
                            <div className="flex flex-col gap-3 md:gap-[0.7vw] lg:gap-[1vw]">
                                <p className="text-sm md:text-[1.6vw] lg:text-[1.5vw] text-zinc-800 font-neue">M:</p>
                                <div className="flex flex-row flex-wrap md:flex-col gap-3 md:gap-1">
                                    {menuLinks.map((item, index) => (
                                        <a
                                            key={index}
                                            href="#"
                                            className="text-base sm:text-lg md:text-[1.5vw] lg:text-[1.4vw] mr-4 md:mr-0 tracking-tight text-zinc-700 relative group font-neue hover:text-zinc-900 transition-colors"
                        ...
                        <div className="flex flex-col gap-8 md:gap-[2vw] lg:gap-[3vw] mt-4 md:mt-2 lg:mt-0">
                            <div className="flex flex-col gap-3 md:gap-3 lg:gap-4">
                                <p className="text-sm md:text-[1.6vw] lg:text-[1.3vw] text-zinc-800 font-neue">E:</p>
                                <div className="flex flex-col">
                                    <a
                                        className="text-base sm:text-lg md:text-[1.4vw] lg:text-[1.1vw] text-zinc-700 font-neue hover:text-zinc-900 transition-colors"
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 md:mr-[3vw] lg:mr-[4.5vw]">
            ...
            <div className="w-full flex justify-center md:justify-start px-6 md:px-8 lg:px-10 mt-1 mb-8 md:mb-10 lg:mb-12">
                <svg
                    width="60"
                    height="24"
                    viewBox="0 0 72 30"
                    ...
                    className="md:w-[60px] md:h-[25px] lg:w-[72px] lg:h-[30px] hover:scale-110 transition-transform duration-300"
                >
                    <path
